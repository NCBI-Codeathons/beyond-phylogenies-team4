...
.option_list = list(
  make_option(c("-d", "--dynamite"), type="character",  default=list.files(pattern="trait_distributions*"),
              help="output trait distributions files from dynamite script", metavar="character")
